 ...
 *
 * Disassembly of SSDT-7-OptTabl.aml, Wed Dec  5 20:30:40 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001498 (5272)
 *     Revision         0x01
 *     Checksum         0xE9
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        {
            \_SB.PCI0.LPCB.EC0.SPIN (0x21, Zero)
            SGON ()
                ...
                Case (0x2A)
                {
                    ...
                    Switch (PSH0)
                    {
                        ...
                        Case (0x02)
                        {
                            Store (0x0102, RETN)
                            Store (Zero, VRV1)
                            Store (\_SB.PCI0.LPCB.EC0.RRAM (0xF5E9), TGPU)
                            Store (Zero, PDTS)
                            Store (Zero, SFAN)
                            Store (Zero, CPUE)
                            Store (Zero, SKNT)
