 ...
 *
 * Disassembly of DSDT.aml, Wed Dec  5 20:30:39 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000168B3 (92339)
 *     Revision         0x02
 *     Checksum         0xC7
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000012)
{
     ...
     * disassembly, but only 20 were resolved (6 unresolved). Additional
    ...
    External (_SB_.PCI0.RP05.PEGP.LCDD._DCS, MethodObj)    // 0 Arguments
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    ...
                    If (LEqual (IIA0, 0x00120041))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x18, Local2)
                    ...
                    If (LEqual (IIA0, 0x00120042))
                    {
                        ...
                        Else
                        {
                            Subtract (0x00010000, 0x19, Local2)
                            And (Local2, 0xFFFF, Local2)
                            Return (Local2)
                        }
                    }
