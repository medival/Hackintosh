 ...
 *
 * Disassembly of DSDT.aml, Tue Nov  6 23:56:47 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00016C5E (93278)
 *     Revision         0x02
 *     Checksum         0x00
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x00000012)
{
    ...
    External (PCCD, UnknownObj)    // (from opcode)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCAB16C18, 0x02B2)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Scope (\_SB.PCI0)
        {
            Device (SIRC)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    CreateDWordField (BUF1, \_SB.PCI0.SIRC._Y13._BAS, BR01)  // _BAS: Base Address
                    CreateDWordField (BUF2, \_SB.PCI0.SIRC._Y14._BAS, BR02)  // _BAS: Base Address
                    CreateDWordField (BUF3, \_SB.PCI0.SIRC._Y15._BAS, BR03)  // _BAS: Base Address
                    CreateDWordField (BUF4, \_SB.PCI0.SIRC._Y16._BAS, BR04)  // _BAS: Base Address
                    CreateDWordField (BUF5, \_SB.PCI0.SIRC._Y17._BAS, BR05)  // _BAS: Base Address
                    CreateDWordField (BUF6, \_SB.PCI0.SIRC._Y18._BAS, BR06)  // _BAS: Base Address
                    CreateDWordField (BUF7, \_SB.PCI0.SIRC._Y19._BAS, BR07)  // _BAS: Base Address
                    CreateDWordField (BUF8, \_SB.PCI0.SIRC._Y1A._BAS, BR08)  // _BAS: Base Address
                    ...
                    If (LNotEqual (BR08, Zero))
                    {
                        ...
                        CreateDWordField (BUFL, \_SB.PCI0.SIRC._Y1B._BAS, LBAS)  // _BAS: Base Address
                        CreateDWordField (BUFH, \_SB.PCI0.SIRC._Y1C._BAS, HBAS)  // _BAS: Base Address
                ...
                Method (CNTR, 1, Serialized)
                {
                    Switch (ToInteger (Arg0))
                    {
                        Case (One)
                        {
                            CreateDWordField (BUF1, \_SB.PCI0.SIRC._Y13._BAS, BAR1)  // _BAS: Base Address
                            Return (BAR1)
                        }
                        Case (0x02)
                        {
                            CreateDWordField (BUF2, \_SB.PCI0.SIRC._Y14._BAS, BAR2)  // _BAS: Base Address
                            Return (BAR2)
                        }
                        Case (0x03)
                        {
                            CreateDWordField (BUF3, \_SB.PCI0.SIRC._Y15._BAS, BAR3)  // _BAS: Base Address
                            Return (BAR3)
                        }
                        Case (0x04)
                        {
                            CreateDWordField (BUF4, \_SB.PCI0.SIRC._Y16._BAS, BAR4)  // _BAS: Base Address
                            Return (BAR4)
                        }
                        Case (0x05)
                        {
                            CreateDWordField (BUF5, \_SB.PCI0.SIRC._Y17._BAS, BAR5)  // _BAS: Base Address
                            Return (BAR5)
                        }
                        Case (0x06)
                        {
                            CreateDWordField (BUF6, \_SB.PCI0.SIRC._Y18._BAS, BAR6)  // _BAS: Base Address
                            Return (BAR6)
                        }
                        Case (0x07)
                        {
                            CreateDWordField (BUF7, \_SB.PCI0.SIRC._Y19._BAS, BAR7)  // _BAS: Base Address
                            Return (BAR7)
                        }
                        Case (0x08)
                        {
                            CreateDWordField (BUF8, \_SB.PCI0.SIRC._Y1A._BAS, BAR8)  // _BAS: Base Address
                            Return (BAR8)
                        }
                        Default
                        {
            ...
            Device (GPI0)
            {
                ...
                Name (RBUF, ResourceTemplate ()
                {
                    DWordIO (ResourceProducer, MinFixed, MaxFixed, PosDecode, EntireRange,
                        ...
                        0x00000000,         // Translation Offset
                        0x00000400,         // Length
                        ,, _Y1D, TypeStatic, DenseTranslation)
                })
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Return (RBUF)
                ...
                CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y1D._MIN, BVAL)  // _MIN: Minimum Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SDMA)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SDMA._Y1E._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (I2C0)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.I2C0._Y1F._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (I2C1)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.I2C1._Y20._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SPI0)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SPI0._Y21._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SPI1)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SPI1._Y22._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (UA00)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.UA00._Y23._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (UA01)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.UA01._Y24._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
            ...
            Device (SDHC)
            {
                ...
                CreateDWordField (RBUF, \_SB.PCI0.SDHC._Y25._BAS, BVAL)  // _BAS: Base Address
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (LEqual (BVAL, Zero))
                    {
        ...
        Scope (I2C1)
        {
            ...
            Device (TPD0)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y26._INT, VAL3)  // _INT: Interrupts
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD1)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y27._INT, VAL3)  // _INT: Interrupts
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD2)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y28._INT, VAL3)  // _INT: Interrupts
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD3)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y29._INT, VAL3)  // _INT: Interrupts
                        Store (0x1B, VAL3)
                    }
            ...
            Device (TPD7)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y2A._INT, VAL3)  // _INT: Interrupts
                        Store (0x1B, VAL3)
                        If (LEqual (S0ID, Zero))
                        {
            ...
            Device (TPD8)
            {
                ...
                Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If (LEqual (GR13, One))
                    {
                        CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y2B._INT, VAL3)  // _INT: Interrupts
                        Store (0x1B, VAL3)
                        If (LEqual (S0ID, Zero))
                        {
                            CreateByteField (SBFI, 0x24, VAL4)
        ...
        Scope (SDHC)
        {
            Device (WI01)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    CreateDWordField (^^RBUF, \_SB.PCI0.SDHC._Y25._BAS, AVAL)  // _BAS: Base Address
                    If (LNotEqual (AVAL, Zero))
                    {
                        CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y2C._LEN, WLN0)  // _LEN: Length
                        Store (0x0C, WLN0)
                        CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y2C._BAS, WVAL)  // _BAS: Base Address
        ...
        Device (ADSP)
        {
            ...
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
                If (LGreaterEqual (OSYS, 0x07DC))
                {
                    If (LEqual (S0ID, One))
                    {
                        CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y2D._BAS, BVAL)  // _BAS: Base Address
                        If (LEqual (BVAL, Zero))
                        {
                            Return (Zero)
                        }
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y2E._BAS, RBR0)  // _BAS: Base Address
                ShiftLeft (^^LPCB.RCBA, 0x0E, RBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y2F._BAS, TBR0)  // _BAS: Base Address
                Store (TBAB, TBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y2F._LEN, TBLN)  // _LEN: Length
                If (LEqual (TBAB, Zero))
                {
                    Store (Zero, TBLN)
                }

                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y30._BAS, SNR0)  // _BAS: Base Address
                Store (SRMB, SNR0)
    ...
    Scope (_SB)
    {
        ...
        Device (ATKD)
        {
            ...
            Method (BSTS, 0, NotSerialized)
            {
                ...
                Store (^^PCI0.LPCB.EC0.RRAM (0xF8FE), Local1)
                Store (Zero, Local2)
                ...
                Else
                {
                    Store (^^PCI0.LPCB.EC0.RRAM (0xF8FE), Local0)
            ...
            Method (GLKB, 1, NotSerialized)
            {
                If (LEqual (Arg0, One))
                {
                    Store (^^PCI0.LPCB.EC0.RRAM (0xF8B0), Local0)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        OperationRegion (ECID, SystemIO, 0x68, One)
        Field (ECID, ByteAcc, NoLock, Preserve)
        {
            EC4D,   8
        }

        OperationRegion (ECIC, SystemIO, 0x6C, One)
    ...
    Scope (_TZ)
    {
        ...
        Method (RTMP, 0, NotSerialized)
        {
            ...
            {
                Store (0xFB, \_SB.PCI0.LPCB.EC0.BRAH)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Method (EC0S, 1, NotSerialized)
        {
            If (LEqual (Arg0, 0x03))
            {
                Store (RRAM (0xF8B0), KBST)
                Store (RRAM (0xF8B1), KBBR)
            }

            If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
            {
                Store (RRAM (0xF8B0), Local0)
    ...
    Scope (_SB)
    {
        Device (LID)
        {
            ...
            {
                Store (One, Local0)
                Store (^^PCI0.LPCB.EC0.RPIN (0xB4), Local0)
                If (LEqual (Local0, Ones))
                {
                    Store (One, Local0)
                }
    ...
    Scope (_SB.PCI0)
    {
        Device (RESC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (BUF0, \_SB.PCI0.RESC._Y35._BAS, PTB0)  // _BAS: Base Address
                Store (PTAB, PTB0)
                CreateDWordField (BUF0, \_SB.PCI0.RESC._Y35._LEN, PTLN)  // _LEN: Length
                If (LEqual (PTAB, Zero))
                {
                    Store (Zero, PTLN)
                }
    ...
    Scope (\)
    {
        ...
        {
            Return (\_SB.PCI0.LPCB.EC0.RPIN (0xB4))
        }
        ...
        Method (DCPS, 1, Serialized)
        {
            Store (\_SB.PCI0.LPCB.EC0.RPIN (0xB0), Local0)
            XOr (Local0, One, Local0)
            Return (Local0)
        }
        ...
        Method (ACPS, 0, Serialized)
        {
            Store (\_SB.PCI0.LPCB.EC0.RPIN (0xB1), Local0)
            XOr (Local0, One, Local0)
            Return (Local0)
        }
    ...
    Scope (_SB)
    {
        Device (ECMD)
        {
            Name (_HID, EisaId ("INT3393"))  // _HID: Hardware ID
            Name (_CID, EisaId ("PNP0C02"))  // _CID: Compatible ID
            Method (_INI, 0, NotSerialized)  // _INI: Initialize
            {
                MNIO ("Enter ECMD _INI \n")
                If (ECMA)
                {
                    MNIO ("ECMA != NULL \n")
                    Store (ECMA, Local0)
                    ...
                    MNIO (Local0)
                    MNIO ("          OK!\n")
                    OperationRegion (ERAM, SystemMemory, Local0, 0x00010000)
                    Field (ERAM, ByteAcc, NoLock, Preserve)
                    {
                        ECRM,   65536
                    }
